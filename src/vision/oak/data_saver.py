...
class DataSaver:
    ...
    def save_data(
        self, session_name, subfolder, timestamp, pose, rgb_image, depth_image, pcd
    ):
        ...
        print(
            f"Data saved for session {session_name}, subfolder {subfolder}, timestamp {timestamp}"
        )
...
data_saver.save_data(
    session_name, subfolder, timestamp, pose, rgb_image, depth_image, pcd
)
