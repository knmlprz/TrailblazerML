...
: ${AMENT_CURRENT_PREFIX:="/home/konrad/TrailblazerML/src/install/depth_camera"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/depth_camera/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/depth_camera/environment/path.sh"
