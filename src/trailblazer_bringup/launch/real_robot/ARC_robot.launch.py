...
def generate_launch_description():
    ...
    description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('trailblazer_bringup'), 'launch/real_robot', 'controllers_robot.launch.py')
        )
    )
    ...
    delayed_controller_manager = TimerAction(period=3.0, actions=[nav2])
